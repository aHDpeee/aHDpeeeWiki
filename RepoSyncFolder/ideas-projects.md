...
---
main_web page
*добавить случайные записи (несколько кнопок с соответствующими полями и полный рандом, добавить кнопку «было полезно»/«выполнено» и сортировку по релевантности ссылки на заметки а не на сайты
