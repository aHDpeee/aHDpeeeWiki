...
---
main_web page
*добавить случайные записи (несколько кнопок с соответствующими полями и полный рандом, добавить кнопку «было полезно» /«выполненои сортировку по релевантности*
